/**
 * This code is from https://github.com/jellyfin/jellyfin-web/ Modifications have been made
 * LICENSE: https://github.com/jellyfin/jellyfin-web/blob/master/LICENSE
 *
...
export default function (options) {
    ...
    const allowedAudioChannels = parseInt('-1');
    ...
    if (canPlayHls() && options.enableHls !== false) {
        if (hlsInFmp4VideoCodecs.length && hlsInFmp4VideoAudioCodecs.length && (browser.safari || browser.tizen || browser.web0s)) {
            profile.TranscodingProfiles.push({
                Container: 'mp4',
                Type: 'Video',
    ...
    const subtitleBurninSetting = "allcomplexformats";
    // @ts-ignore
